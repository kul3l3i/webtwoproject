            ...
            ` : `
                ...
                <div class="cart-footer">
                    ...
                    <div class="cart-actions">
                        <button class="continue-shopping">Continue Shopping</button>
                        <a href="sign-in.html"><button class="checkout-button">Proceed to Checkout</button></a>
                    </div>
                </div>
                
                ${!isLoggedIn ? `
                <div class="login-notice">
                    <p>Please <a href="sign-in.html" class="login-link">sign in</a> or <a href="signup.html" class="signup-link">register</a> to proceed with your purchase.</p>
                </div>
                ` : ''}
            `}
        </div>
...
function addCartModalEventListeners(modal, cart, isLoggedIn) {
    ...
    if (checkoutBtn) {
        checkoutBtn.addEventListener('click', () => {
            if (isLoggedIn) {
                ...
                window.location.href = 'sign.html?redirect=checkout';
            }
        });
    }
    ...
    if (signupLink) {
        signupLink.addEventListener('click', (e) => {
            e.preventDefault();
            window.location.href = 'sign-up.html?redirect=checkout';
        });
    }
}
